...
namespace UnitTests
{
    ...
    {
        public Example.BankProcessing bp { get; set; }

        public BankUnitTests()
        {
            bp = new Example.BankProcessing();
        }
        [TestMethod]
        ...
        public void TestDepositFailure()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() => bp.Deposit(bank, 1, -50));
        }
        ...
        public void TestWithdrawlFailure()
        {
                ...
                Accounts = new List<Account>
            {
                new Account() { AccountId=1,
                        Owner = "Adam Smith",
                        Description = "Checking",
                        AcctType = AccountType.Investment,
                        Balance = 5 }
            }
            };
        ...
        public void TestTransferFailure()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() => bp.Transfer(bank, 1, 2, -100.50));
        }
    }
}
